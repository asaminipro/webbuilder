...
<!--***************************************************END OF Modal-THE LOGIN POPUP **************************************************************************** -->
	...
	<br>
		...
		<form action="login_serve" method="POST">
				...
				<tr>
				<td> USERNAME</td>
				<td> <input type="text" id="uname" name="uname" class="form-control" placeholder="Pleae enter your User Name"></td>
				</tr>
				<tr>
				<td> PASSWORD</td>
				<td> <input type="password" id="password" name="password" class="form-control" placeholder="Pleae enter your Password"></td>
				</tr>
				<tr>
				
				<td colspan="2"><button type="submit" class="btn-primary col-lg-12" name="submit" style="padding-top:20px;">LOGIN</button></td>
				</tr>
