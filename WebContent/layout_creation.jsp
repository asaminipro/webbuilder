					...
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								...
								<li><a href="layout_creation.jsp">LAYOUT CREATION</a></li>
								<li><a href="layout_manangement.jsp">LAYOUT MANAGEMENT</a></li>
								<li><a href="payment_option.jsp">PAYMENT</a></li>
