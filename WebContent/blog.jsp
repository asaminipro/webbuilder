			...
			<!-- **********************************************END LOGIN FORM ********************************************************************-->
																	...
																	<div class="row form-group">
																		<div class="col-md-6">
																			...
																			<input type="text" id="name" class="form-control" placeholder="Pleae enter your Name">
																		</div>
																		<div class="col-md-6">
																			<label for="phoneno">PHONE NUMBER</label>
																			<input type="text" id="pno" class="form-control" placeholder="Pleae enter your phone number">
																		</div>
																		<div class="col-md-12">
																			<label for="email">EMAIL</label>
																			<input type="text" id="email" class="form-control" placeholder="Pleae enter your Name">
																		</div>
																		
																		<div class="col-md-6">
																			<label for="pass">PASSWORD</label>
																			<input type="password" id="lname" class="form-control" placeholder="Your password">
																		</div>
																		<div class="col-md-6">
					...
					<div class="col-md-4">
						<div class="blog-entry">
							<div class="blog-img">
								...
								<a href="blog.html"><img src="images/blog-2.jpg" style="width:100%" class="img-responsive" alt="html5 bootstrap template"></a>
					...
					<div class="col-md-4">
						<div class="blog-entry">
							...
							<div class="desc">
								...
								<h2><a href="blog.html">Travel</a></h2>
					...
					<div class="col-md-4">
						<div class="blog-entry">
							...
							<div class="desc">
								...
								<p>No doubt, Tough is a solid free HTML interior design website 
								template that helps you push your works and services to a new degree. </p>
							</div>
						</div>
					</div>
					<div class="col-md-4">
