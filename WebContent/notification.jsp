	...
	<div id="page">
					...
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								...
								<li><a href="user_manager.jsp">USER MANAGER</a></li>
								<li><a href="sql_management.jsp">SQL MANAGER</a></li>
								<li><a href="bugs_identificaton.jsp">BUGS</a></li>
		...
		<table border="2">
			...
			<tr>
				...
				<td><input type="time" style="padding:10px"></td>
			</tr>
			<tr>
			<td style="padding:10px"><input type="button" name="noti_publish" value="publish notification"></td>
			<td style="padding:40px"><input type="button" name="noti_cancel" value="cancel"></td>
			</tr>
			</table>
			</center>
		</form>
